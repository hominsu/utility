...
#ifndef UTILITY_INCLUDE_UTILITY_TIMESTAMP_H_
#define UTILITY_INCLUDE_UTILITY_TIMESTAMP_H_
...
inline int to_string(char *_data, size_t _size) {
...
#endif //UTILITY_INCLUDE_UTILITY_TIMESTAMP_H_
